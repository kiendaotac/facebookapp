                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item wrap-gallery">
                                    <ul>
                                        <li><a href="#" class="link-to-item"><figure><img src="{{ asset('assets/images/brands/american-express.jpg') }}" alt="american express"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="{{ asset('assets/images/brands/paypal.jpg') }}" alt="paypal"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="{{ asset('assets/images/brands/visa.jpg') }}" alt="paypal"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="{{ asset('assets/images/brands/master-card.jpg') }}" alt="master card"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="{{ asset('assets/images/brands/discover.jpg') }}" alt="discovery"></figure></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
